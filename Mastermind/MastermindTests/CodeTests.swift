...
class CodeTests: XCTestCase {
    func testFeedback() {
        ...
        XCTAssertEqual(try! Code.Feedback(guess: [.red, .yellow, .orange, .blue], answer: code), Code.Feedback(perfect: 4))
        XCTAssertEqual(try! Code.Feedback(guess: [.red, .yellow, .orange, .green], answer: code), Code.Feedback(perfect: 3))
